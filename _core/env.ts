...
export const ENV = {
  ...
  firebaseApiKey: import.meta.env.NEXT_PUBLIC_FIREBASE_API_KEY || '',
  firebaseAuthDomain: import.meta.env.NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN || '',
  firebaseProjectId: import.meta.env.NEXT_PUBLIC_FIREBASE_PROJECT_ID || '',
  firebaseStorageBucket: import.meta.env.NEXT_PUBLIC_FIREBASE_STORAGE_BUCKET || '',
  firebaseMessagingSenderId: import.meta.env.NEXT_PUBLIC_FIREBASE_MESSAGING_SENDER_ID || '',
  firebaseAppId: import.meta.env.NEXT_PUBLIC_FIREBASE_APP_ID || '',
  firebaseMeasurementId: import.meta.env.NEXT_PUBLIC_FIREBASE_MEASUREMENT_ID || '',
